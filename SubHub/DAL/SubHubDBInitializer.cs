...
namespace SubHub.DAL
{
    public class SubHubDBInitializer : System.Data.Entity.DropCreateDatabaseAlways<SubHubContext>
    {
        protected override void Seed(SubHubContext context)
        {
            ...
            Subtitle subtitle19 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-8), LanguageId = 2, Users = new List<ApplicationUser>() { userManager.FindByName("user1") }, MediaId = 19 };
            Subtitle subtitle20 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-9), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user3") }, MediaId = 20 };
            Subtitle subtitle21 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-2), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user1"), userManager.FindByName("user2") }, MediaId = 21 };
            Subtitle subtitle22 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-6), LanguageId = 2, Users = new List<ApplicationUser>() { userManager.FindByName("user1") }, MediaId = 22 };
            Subtitle subtitle23 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-13), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user2"), userManager.FindByName("user3") }, MediaId = 23 };
            Subtitle subtitle24 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-7), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user1") }, MediaId = 24 };
            Subtitle subtitle25 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-1), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user1"), userManager.FindByName("user2") }, MediaId = 25 };
            Subtitle subtitle26 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-2), LanguageId = 2, Users = new List<ApplicationUser>() { userManager.FindByName("user3") }, MediaId = 26 };
            Subtitle subtitle27 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-3), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user2"), userManager.FindByName("user3") }, MediaId = 27 };
            Subtitle subtitle28 = new Subtitle { DateSubmitted = DateTime.Now.AddDays(-11), LanguageId = 1, Users = new List<ApplicationUser>() { userManager.FindByName("user2"), userManager.FindByName("user3") }, MediaId = 28 };
